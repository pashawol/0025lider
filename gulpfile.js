...
function app() { 
    return src([sourse + '/pug/blocks/**/*.js',])
        .pipe(rigger())
...
function startwatch() {
    ...
    watch([sourse + '/pug/**/*.js'], { usePolling: true }, app);
...
export default series(common, libs, styles, app, sprite, pugFiles, parallel(browsersync, startwatch))